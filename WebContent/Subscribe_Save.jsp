...
stmt.executeUpdate("insert into subscriber values ('"+name+"','"+tel+"','"+email+"','"+relation+"','"+carnum+"','"+coporname+"','"+birth+"','"+pw+"','"+cause+"')");

out.println("<h1><font size=4 color=DodgeBlue face=맑은고딕>"+name+" 님 신청이 완료되었습니다.</font></h1>");
